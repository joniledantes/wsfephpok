		...
		if ($conf->facture->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				*/
				...
				$pdf->MultiCell($this->posfac['pos_factu_mpago']['w'], $this->posfac['pos_factu_mpago']['h'], '  ____________________________________', 0, $this->posfac['pos_factu_mpago']['alig']);
...
*/
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs,$intCopias=1)
	{
		...
		$pdf->SetFont($this->posfac['pos_factu_letra']['font'],$this->posfac['pos_factu_letra']['style'],$this->posfac['pos_factu_letra']['size']);
		$pdf->SetXY($this->posfac['pos_factu_letra']['x'],$this->posfac['pos_factu_letra']['y']);
		$pdf->MultiCell($this->posfac['pos_factu_letra']['w'],$this->posfac['pos_factu_letra']['h'],"FACTURA " . $letfact,0,$this->posfac['pos_factu_letra']['alig']);

		$pdf->SetFont($this->posfac['pos_factu_cod']['font'],$this->posfac['pos_factu_cod']['style'],$this->posfac['pos_factu_cod']['size']);
		$pdf->SetXY($this->posfac['pos_factu_cod']['x'],$this->posfac['pos_factu_cod']['y']);
		...
		*/
		...
		$title= ' Nro: F' .  $letfact . '-' . str_pad($this->wsfe->puntodeventa, 4,"0",STR_PAD_LEFT) ."-".str_pad($this->wsfe->cbtnro, 8,"0",STR_PAD_LEFT);
		...
		$pdf->SetXY($this->posfac['pos_factu_pag']['x'],$this->posfac['pos_factu_pag']['y']);
		...
		if ($object->ref_client)
		{
			...
			$pdf->SetXY($this->posfac['pos_factu_refcli']['x'],$this->posfac['pos_factu_refcli']['y']);
		...
		$pdf->SetFont($this->posfac['pos_factu_fec']['font'],$this->posfac['pos_factu_fec']['style'],$this->posfac['pos_factu_fec']['size']);
