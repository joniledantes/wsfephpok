...
var Ticket = jQuery.Class({
    ...
    calculeDiscountTotal: function (total_lines) {
        ...
        $('#totalProdTicket').html(this.totalprod);
    ...
    editTicketLine: function (idProduct) {
        ...
        $('#id_btn_editTicketline').click(function () {
            if (_TPV.ticket.checkApplyQuantity(idProduct, $('#line_quantity').val().replace(',', '.'))) {
    ...
    addDiscount: function () {
        ...
        $('#id_btn_add_discount').click(function () {
            _TPV.ticket.discount_percent = $('#ticket_discount_perc').val().replace(',', '.');
			if (typeof $('#ticket_discount_qty').val() == 'undefined'){
				_TPV.ticket.discount_qty = 0;
			}
			else {
				_TPV.ticket.discount_qty = $('#ticket_discount_qty').val().replace(',', '.');
			}
            _TPV.ticket.calculeTotal();
            //$('#idDiscount').hide();
            //$('#products').show();
    ...
    addTicketNote: function () {
        ...
        $('#id_btn_ticket_note').click(function () {
            ...
            $('#total_notas').append('<span style="color:white";>'+_TPV.ticket.note+'</span><br/>');
    ...
    getHtml: function () {
        ...
        if (this.diff_price == 0) {
            if (_TPV.defaultConfig['module']['ttc'] == 0) {
                ...
                return '<tr id="ticketLine' + this.idProduct + '" onclick="_TPV.ticket.showTicketOptions(' + this.idProduct + ')"><td class="idCol">' + this.idProduct + '</td><td class="description">' + this.label + '<span id="noteL' + this.idProduct + '"></span></td><td class="discount">' + this.discount + '%</td><td class="price">' + pu + '</td><td class="cant">' + this.cant + '</td><td class="total">' + ht + '</td><td class="colActions"><a class="action edit" onclick="_TPV.ticket.editTicketLine(' + this.idProduct + ');"></a><a class="action delete" onclick="_TPV.ticket.deleteLine(' + this.idProduct + ');"></a><a class="action info" onclick="' + hide + '"></a><a class="action close" onclick="_TPV.ticket.hideTicketOptions(' + this.idProduct + ')"></a></td></tr>';
            }
            else {
                return '<tr id="ticketLine' + this.idProduct + '" onclick="_TPV.ticket.showTicketOptions(' + this.idProduct + ')"><td class="idCol">' + this.idProduct + '</td><td class="description">' + this.label + '<span id="noteL' + this.idProduct + '"></span></td><td class="discount">' + this.discount + '%</td><td class="price">' + displayPrice(this.total_ttc / this.cant) + '</td><td class="cant">' + this.cant + '</td><td class="total">' + displayPrice(this.total_ttc) + '</td><td class="colActions"><a class="action edit" onclick="_TPV.ticket.editTicketLine(' + this.idProduct + ');"></a><a class="action delete" onclick="_TPV.ticket.deleteLine(' + this.idProduct + ');"></a><a class="action info" onclick="' + hide + '"></a><a class="action close" onclick="_TPV.ticket.hideTicketOptions(' + this.idProduct + ')"></a></td></tr>';
            }
        }
        else {
            var txt = ajaxDataSend('Translate', 'DiffPrice');
            if (_TPV.defaultConfig['module']['ttc'] == 0)
                return '<tr id="ticketLine' + this.idProduct + '" onclick="_TPV.ticket.showTicketOptions(' + this.idProduct + ')"><td class="idCol">' + this.idProduct + '</td><td class="description">' + this.label + '<span id="noteL' + this.idProduct + '"></span></td><td class="discount">' + this.discount + '%</td><td class="price"><img style="float: left; margin: 3% 0px 0px 26%;" src="img/alert.png" title="' + txt + '">  ' + displayPrice(this.total_ht / this.cant) + '</td><td class="cant">' + this.cant + '</td><td class="total">' + displayPrice(this.total_ht) + '</td><td class="colActions"><a class="action edit" onclick="_TPV.ticket.editTicketLine(' + this.idProduct + ');"></a><a class="action delete" onclick="_TPV.ticket.deleteLine(' + this.idProduct + ');"></a><a class="action info" onclick="' + hide + '"></a><a class="action close" onclick="_TPV.ticket.hideTicketOptions(' + this.idProduct + ')"></a></td></tr>';
            else
                return '<tr id="ticketLine' + this.idProduct + '" onclick="_TPV.ticket.showTicketOptions(' + this.idProduct + ')"><td class="idCol">' + this.idProduct + '</td><td class="description">' + this.label + '<span id="noteL' + this.idProduct + '"></span></td><td class="discount">' + this.discount + '%</td><td class="price"><img style="float: left; margin: 3% 0px 0px 26%;" src="img/alert.png" title="' + txt + '">  ' + displayPrice(this.total_ttc / this.cant) + '</td><td class="cant">' + this.cant + '</td><td class="total">' + displayPrice(this.total_ttc) + '</td><td class="colActions"><a class="action edit" onclick="_TPV.ticket.editTicketLine(' + this.idProduct + ');"></a><a class="action delete" onclick="_TPV.ticket.deleteLine(' + this.idProduct + ');"></a><a class="action info" onclick="' + hide + '"></a><a class="action close" onclick="_TPV.ticket.hideTicketOptions(' + this.idProduct + ')"></a></td></tr>';
        }
    },
...
var TPV = jQuery.Class({
    ...
    setButtonEvents: function () {
        ...
        $('#btnReturnTicket').click(function () {
            if((_TPV.ticket.state=='2' && _TPV.ticket.type=='0') || (_TPV.ticket.state=='1' && _TPV.ticket.type=='0' && _TPV.ticket.check=='1')) {
                var i = 0;
                var cont = 0;
                var arr = [];

                while (i < _TPV.ticket.oldproducts.length) {
                    var id = _TPV.ticket.oldproducts[i]['idProduct'];
            ...
            if(i>0) {
                i = 0;
                while (i < arr.length) {
                    _TPV.ticket.addReturnProduct(arr[i]);
                    i++;
                }
            }
        });
        ...
        $('#pay_all_0').click(function () {//tactil mode
            _TPV.ticket.difpayment = parseFloat(_TPV.ticket.difpayment);
            if ($('#pay_client_0').val() != "")
    ...
    pointsClient: function () {
        _TPV.ticket.points = $('#points_client_id').val().replace(',', '.');
            ...
            $.each(result, function (id, item) {
                ...
                $.each(item['lines'], function (idline, line) {
                    if (!edit) {
                        ...
                        if(_TPV.ticket.state=='1' && _TPV.ticket.type=='0') {
                ...
                if (!edit) {
                    ...
                    $('#totalProdTicket').html(_TPV.ticket.totalprod);
                ...
                if(item['remain']){
                    _TPV.ticket.total = item['remain'];
                    _TPV.ticket.calculeDiscountTotal(item['remain']);
                    $('#btnOkTicket').show();
                }
                showTicketContent();
            });
            ...
            $.each(result, function (id, item) {
                ...
                $.each(item['lines'], function (idline, line) {
                    if (!edit) {
                        ...
                        if(_TPV.ticket.state=='2' && _TPV.ticket.type=='0') {
                            $('#all-head').removeAttr('style');
                            $('#all-head').css('width','70px');
                            var tr = '<tr id="ticketLine' + line['idProduct'] + '"><td class="idCol" >' + line['idProduct'] + '</td><td class="description">' + line['label'] + '</td><td class="discount">' + line['discount'] + '%</td><td class="price">' + displayPrice(line['price_ht'] * (1 + line['tva_tx'] / 100)) + '</td><td class="cant">' + line['cant'] + '</td><td class="total">' + totalLine + '</td><td class="check"><input type="checkbox" id="line' + line['idProduct'] + '" name="' + line['idProduct'] + '" /></td>';
                        }
                        else{
                            $('#all-head').css('display','none');
                            _TPV.ticket.check = '0';
                ...
                if (!edit) {
                    ...
                    var cont = 0;
                    while(i < _TPV.ticket.oldproducts.length){
                        cont = cont + parseInt(_TPV.ticket.oldproducts[i].cant);
                        i++;
                    }
                    $('#totalProdTicket').html(cont);
                    //$('#totalTicket').html(displayPrice(total));
                }
                if(item['remain']){
                    $('#btnOkTicket').show();
    ...
    searchByRef: function (stat, pag) {
        ...
        $.each(result, function (id, item) {
            ...
            $('#historyTable').append('<tr id="historyTicket' + item['id'] + '" onclick="_TPV.ticket.showHistoryOptions(' + item['id'] + ')" class="data"><td><a class="icontype state' + item['statut'] + ' type' + item['type'] + '"></a>' + item['ticketnumber'] + '</td><td>' + date + '</td><td>' + item['terminal'] + '</td><td>' + item['seller'] + '</td><td>' + item['client'] + '</td><td style="text-align:right;">' + item['lines'] + '</td><td style="text-align:right;">' + displayPrice(item['amount']) + '</td><td class="colActions"  style="text-align:center">' + actionsHtml + '</tr>');
            _TPV.showingTick++;
        });
    ...
    searchByRefFac: function (stat, pag) {
        ...
        $.each(result, function (id, item) {
            ...
            if (item['statut'] == 0) {
                edit = true;
                delet = true;
                if(item['ticketnumber'].substring(0,5)=='(PROV') {
                    strticket = "'ticket'";
                }
            }
    ...
    loadMoreProducts: function (category, pag) {
        ...
        $.getJSON(`./ajax_pos.php?action=getMoreProducts&category=${category}&pag=${pag}&ticketstate=${_TPV.ticket.type}&token=${token}`, function (data) {
            $.each(data, function (key, val) {
    ...
    getProducts: function (category) {
        ...
        if (typeof category != 'undefined') {
            ...
            $.getJSON(`./ajax_pos.php?action=getProducts&category=${category}&ticketstate=${_TPV.ticket.type}&token=${token}`, function (data) {
            	if (data == null) {
            		var data = []; // for avoid jquery error
            	}
                $.each(data, function (key, val) {
        ...
        if(!result1) {
            ...
            $('#id_btn_ticketLine').click(function () {
                ...
                if(result){
                    ...
                    $('#id_btn_ticketLine_body').unbind('click');
                    $('#id_btn_ticketLine_body').click(function () {
                        var email = new Object();
                        email.idTicket = idTicket;
