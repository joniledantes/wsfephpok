		...
		<div id="idCashMode" class="leftBlock bloqueOpciones" style="display:none" title="<?php echo $langs->trans("CloseCash"); ?>">
			...
			<div class="options">
					...
					<li><div id="typeDiscount0">
						<label><?php echo $langs->trans("Percent"); ?></label><input autocomplete="off" onclick="this.select()" type="text" size="5" name="ticket_discount_perc" id="ticket_discount_perc"  value="0" class="numKeyboard" />
					</div>
                ...
                <div class="but" id="btnSaveTicket" name="btnSaveTicket"><img height=" " width=" " title="<?php echo $langs->trans("CreateDraftTicket"); ?>" src="./img/saveTicket.png">
                    ...
                    if($_SESSION['discount']) {
                        ...
                        <div class="but" name="btnAddDiscount" id="btnAddDiscount"><img height=" " width=" "
                                                                                        title="<?php echo $langs->trans("ApplyDiscountTicket"); ?>"
                  ...
                  <div id="totalCartTicket">
                    ...
                    <div class="total_but">
                       ...
                       <span class="number">
						   ...
						   <span id="totalProdTicket" style="font-weight: normal;font-size: 15px" >0</span><span style="font-weight: normal;font-size: 15px" > Ud</span>
						   <?php } ?>
						   <span id="totalTicket" style="font-size: 25px;">0</span>&nbsp;<?php echo $conf->currency ?><span id="alertfaclim" >
...
<div id="showpanels" style="display:none">
            ...
            <div class="options">
                <ul style="list-style-type: none">
                    <li><textarea autocomplete="off" style="width:300px;" onclick="this.select()" type="text" rows="30" cols="50" maxlength="400" name="mail_body" id="mail_body"  value="" class="quertyKeyboard"></textarea>
                        <br clear="all" />
                        <input type="button" id="id_btn_ticketLine_body" value="<?php echo $langs->trans("Send"); ?>" class="btn3dbig" style="margin: inherit"></li>
                </ul>
            </div>
        </div>
		...
		<div id="ticketNote" class="bloqueOpciones" style="display:none" title="<?php echo $langs->trans("TicketNote"); ?>">
			<div class="options">
                ...
                <ul>
				<li><label><?php echo $langs->trans("Note"); ?></label><input autocomplete="off" onclick="this.select()" type="text" size="10" name="ticket_note" id="ticket_note"  value="" class="quertyKeyboard" />
